  ...
  describe '#task1' do
    ...
    context 'when logs have one error' do
      ...
      it 'returns one error' do
        expect(subject).to eq('2021-04-23 20:30:42: SSL error, peer: 10.6.246.101, peer cert: , #<Puma::MiniSSL::SSLError: System error: Undefined error: 0 - 0>')
      end
    end
